local function set_csharp_doc_highlights()
  vim.api.nvim_set_hl(0, "@lsp.type.xmlDocCommentName.cs", { link = "@lsp.type.builtinType" })
  vim.api.nvim_set_hl(0, "@lsp.type.xmlDocCommentAttributeName.cs", { link = "@markup.emphasis" })
  vim.api.nvim_set_hl(0, "@lsp.type.xmlDocCommentAttributeQuotes.cs", { link = "@string" })
end
-- Run immediately on startup
set_csharp_doc_highlights()

-- Re-run on colorscheme change
vim.api.nvim_create_autocmd("ColorScheme", {
  pattern = "*",
  callback = set_csharp_doc_highlights,
})
